...
bool 	EnableLogging 		= true;		// Perhaps remove this from externs once its working well
...
bool GrabWeb(string strUrl, string& strWebPage)
{
   ...
   //string sBuffer;
	...
	hInternet = InternetOpenUrlW(hSession(FALSE), strUrl, "0", 0, 
								...
								*/
   hInternet = InternetOpenUrlW(hSession(FALSE), 
                                strUrl, 
                                NULL, 
                                0, 
