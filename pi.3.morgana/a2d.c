...
volatile unsigned char a2d_complete_flag;
...
void a2dInit(void)
{
	...
	a2d_complete_flag = FALSE;		// clear conversion complete flag
...
unsigned char a2dConvert8bit(unsigned char ch)
{
	...
	return a2d_convert_10bit(ch)>>2;			// return ADC MSB byte
}
