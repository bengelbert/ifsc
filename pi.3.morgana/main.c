...
//  Versão			: 1.1
//  Descrição	 	: Meter Electric Magnitudes Microcontrolled Interface with printing Date and Time updated
//  Autores			: Geiser Prá Vicenzi e Morgana Cristina Lô
...
#define FlagAD !(ADCSRA & (1<<ADIF)) //FLAG DE FIM DE CONVERSÃO
